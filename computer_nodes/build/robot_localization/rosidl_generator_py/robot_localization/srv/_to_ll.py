...
class Metaclass_ToLL_Event(type):
    """Metaclass of message 'ToLL_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__to_ll__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__to_ll__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__to_ll__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__to_ll__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__to_ll__event
...
class ToLL_Event(metaclass=Metaclass_ToLL_Event):
    """Message class 'ToLL_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robot_localization/ToLL_Request, 1>',
        'response': 'sequence<robot_localization/ToLL_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_localization', 'srv'], 'ToLL_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_localization', 'srv'], 'ToLL_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robot_localization.srv import ToLL_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, ToLL_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'ToLL_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from robot_localization.srv import ToLL_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, ToLL_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'ToLL_Response'"
...
class Metaclass_ToLL(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _to_ll.Metaclass_ToLL_Event._TYPE_SUPPORT is None:
                _to_ll.Metaclass_ToLL_Event.__import_type_support__()
...
class ToLL(metaclass=Metaclass_ToLL):
    ...
    from robot_localization.srv._to_ll import ToLL_Event as Event

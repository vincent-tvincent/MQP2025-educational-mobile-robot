...
class Metaclass_SetDatum_Event(type):
    """Metaclass of message 'SetDatum_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__set_datum__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__set_datum__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__set_datum__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__set_datum__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__set_datum__event
...
class SetDatum_Event(metaclass=Metaclass_SetDatum_Event):
    """Message class 'SetDatum_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robot_localization/SetDatum_Request, 1>',
        'response': 'sequence<robot_localization/SetDatum_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_localization', 'srv'], 'SetDatum_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_localization', 'srv'], 'SetDatum_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robot_localization.srv import SetDatum_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, SetDatum_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'SetDatum_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from robot_localization.srv import SetDatum_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, SetDatum_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'SetDatum_Response'"
...
class Metaclass_SetDatum(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if _set_datum.Metaclass_SetDatum_Event._TYPE_SUPPORT is None:
                _set_datum.Metaclass_SetDatum_Event.__import_type_support__()
...
class SetDatum(metaclass=Metaclass_SetDatum):
    ...
    from robot_localization.srv._set_datum import SetDatum_Event as Event

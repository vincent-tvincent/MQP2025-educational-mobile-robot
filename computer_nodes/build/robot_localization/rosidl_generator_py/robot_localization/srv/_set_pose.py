...
class SetPose_Event(metaclass=Metaclass_SetPose_Event):
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<robot_localization/SetPose_Request, 1>',
        'response': 'sequence<robot_localization/SetPose_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_localization', 'srv'], 'SetPose_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['robot_localization', 'srv'], 'SetPose_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from robot_localization.srv import SetPose_Request
    ...
    def response(self, value):
        if self._check_fields:
            from robot_localization.srv import SetPose_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
...
class SetPose(metaclass=Metaclass_SetPose):
    ...
    from robot_localization.srv._set_pose import SetPose_Event as Event

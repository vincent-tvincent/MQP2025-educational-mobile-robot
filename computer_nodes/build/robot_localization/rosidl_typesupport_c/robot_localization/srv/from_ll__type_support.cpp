...
static const _FromLL_Event_type_support_symbol_names_t _FromLL_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, robot_localization, srv, FromLL_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, robot_localization, srv, FromLL_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, robot_localization, srv, FromLL_Event)() {
  return &::robot_localization::srv::rosidl_typesupport_c::FromLL_Event_message_type_support_handle;
}
...
static const rosidl_service_type_support_t FromLL_service_type_support_handle = {
  ...
  &FromLL_Request_message_type_support_handle,
  &FromLL_Response_message_type_support_handle,
  &FromLL_Event_message_type_support_handle,

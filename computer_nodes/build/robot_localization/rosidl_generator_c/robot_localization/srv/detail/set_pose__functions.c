...
robot_localization__srv__SetPose_Request__create(void)
{
...
robot_localization__srv__SetPose_Response__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
...
robot_localization__srv__SetPose_Event__create(void)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
